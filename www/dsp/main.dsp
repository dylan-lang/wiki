...
<%dsp:include url="xhtml-start.dsp"/>
        ...
        <hr/>
        <p>
          More information about the <a href="/books/drm/Background_and_Goals.html">background and goals</a> of the Dylan language
                                        are available in the <a href="/books/drm/Title">Dylan Reference Manual</a>.
          To get a quick feel of the language have a look at some <a href="/pages/Fragments">code examples</a>.
        </p>
        <p>
          We currently maintain two <a href="/pages/Implementations">implementations</a> of Dylan
          and we're working on a number of <a href="/pages/Projects">projects</a>.
        </p>
        <p>Please feel free to <a href="/pages/Community">join us</a>!</p> 
        <h2>News</h2>
                                <wiki:list-pages tags="news" sort="published">
